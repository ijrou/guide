# Markdown学习手册(GitHub)
***
> 你当前进入的页面是教你如何书写Markdown语法的教程。GitHub上的markdown语法在标准的markdown语法基础上做了扩充，称之为`GitHub Flavored Markdown`。简称`GFM`，GFM在GitHub上有广泛应用，除了README文件外，issues和wiki均支持markdown语法。
...
|#|语法|效果|
|---|----|-----
|1|`[我的博客](http://nding78.com/ "悬停显示")`|[我的博客](http://nding78.com/ "悬停显示")
